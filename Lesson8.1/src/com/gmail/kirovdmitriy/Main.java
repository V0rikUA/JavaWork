...
public class Main {
	...
	public static void saveStringToFile(String text, File file) { // Метод записи чего-то в файл
	...
	public static String getInfo(String[] names, String[] lastName, int[] moneys) {  //Цикл(метод) сбор предоставленной информации и растановка по строкам
